...
const SearchBarName1235 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('http://localhost:4000/students/temp1235', { "name": value, "Address": value1, "Common": value2, "Regeion": value3, "Fec_Nac": value4 })
                        .then((response) => {
