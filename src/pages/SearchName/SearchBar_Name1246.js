...
const SearchBarName1246 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('http://localhost:4000/students/temp1246', { "name": value, "Address": value1, "Common": value2, "Salud": value3, "DV": value4 })
                        .then((response) => {
...
export default SearchBarName1246;
