...
const SearchBarName256 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('http://localhost:4000/students/temp256', { "name": value, "Common": value1, "Fec_Nac": value2, "DV": value3 })
                        .then((response) => {
            ...
            <div className="row" style={{marginTop: "20px"}}>
                ...
                <div className="col-6 position-relative" style={{paddingLeft: "5px"}}>
                    <input type="text" alt="search" placeholder="DV" className="input_name" value={value3} onChange={(e) => { setValue3(e.target.value) }} />
                </div>                
            </div>
...
export default SearchBarName256;
