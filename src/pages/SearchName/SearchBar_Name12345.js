...
const SearchBarName12345 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('http://localhost:4000/students/temp12345', { "name": value, "Address": value1, "Common": value2, "Regeion": value3, "Salud": value4, "Fec_Nac": value5 })
                    .then((response) => {
