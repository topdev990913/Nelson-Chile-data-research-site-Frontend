...
const SearchBarName12356 = ({ setListData }) => {
    ...
    return (
        <div className="searchbar_out" onKeyUp={(e) => {
            if (e.key === "Enter") {
                console.log("-------------------")
                axios.post('http://localhost:4000/students/temp12356', { "name": value, "Address": value1, "Common": value2, "Regeion": value3, "Fec_Nac": value4, "DV": value5 })
                        .then((response) => {
            ...
            <div className="col-4 position-relative" style={{paddingLeft: "5px"}}>
                ...
                <div className="col-4 position-relative" style={{paddingRight: "5px"}}>
                    <input type="text" alt="search" placeholder="DV" className="input_name" value={value5} onChange={(e) => { setValue5(e.target.value) }} />
                </div>             
            </div>
